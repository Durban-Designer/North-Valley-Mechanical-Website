<template>
  <div class="main">
    ...
    <div class="registerEmployee" v-else-if="modal==='register'">
      ...
      <input class="middleNameRegister" v-model="activeUser.middleName" placeholder="Middle Name"></input>
      <input class="lastNameRegister" v-model="activeUser.lastName" placeholder="Last Name"></input>
      <input class="phoneRegister" v-model="activeUser.phone" placeholder="(***)-***-****"></input>
